...
public class FieldLayout {
    ...
    public static boolean isBlueAlliance(String allianceColor) {
        return allianceColor.equalsIgnoreCase("blue");
    }
    public static boolean isRedAlliance(String allianceColor) {
        return allianceColor.equalsIgnoreCase("red");
    }

    // Add the AprilTag maps for Red and Blue alliances
    public static final Map<Integer, AprilTag> kAprilTagMapRed = loadAprilTagMapForRed();
    public static final Map<Integer, AprilTag> kAprilTagMapBlue = loadAprilTagMapForBlue();

    // Load the AprilTag maps for Red and Blue alliances
    private static Map<Integer, AprilTag> loadAprilTagMapForRed() {
        // Replace this with the actual code to load the Red alliance tags
        return new HashMap<>();  // Placeholder for Red tags
    }

    private static Map<Integer, AprilTag> loadAprilTagMapForBlue() {
        // Replace this with the actual code to load the Blue alliance tags
        return new HashMap<>();  // Placeholder for Blue tags
    }
