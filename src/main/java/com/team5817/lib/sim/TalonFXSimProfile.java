package com.team5817.lib.sim;

import static com.team5817.lib.sim.PhysicsSim.*;
...
class TalonFXSimProfile extends SimProfile {
	...
	public TalonFXSimProfile(
			final TalonFX falcon, final double accelToFullTime, final double fullVel, final boolean sensorPhase) {
		this._falcon = falcon;
	...
	public void run() {
		...
		_falcon.getSimState().addRotorPosition((int) (_vel * period / 100));
